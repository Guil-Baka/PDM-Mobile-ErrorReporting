...
- **Pré-preenchimento da Nova Ocorrência**: Uso a
  utomático de dados básicos da ocorrência encerrada como base para abertura da nova Ocorrência de Infraestrutura.
